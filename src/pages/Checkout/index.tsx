...
import { CheckoutContainer, DeliveryAddress, Form, FormAdress, Input, InputDiv, Order, Payment, PaymentForm, PaymentMethod, ProductSelected, ProductService, ServicersContainer, Subtitle, Title, TitleRequisition } from "./styles";
...
export function Checkout() {
    return (
       <CheckoutContainer>
            ...
            <ServicersContainer>
                <ProductService>
                    <TitleRequisition>Complete seu pedido</TitleRequisition>
                    <Order>
                        <DeliveryAddress>
                            <FormAdress>
                                <div>   
